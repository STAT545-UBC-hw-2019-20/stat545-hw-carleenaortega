...
```
We now know that `continent` is a factor with 5 levels named Africa, Americas, Asia, Europe, and Oceania.

Now that we have verified that `continent` is a factor, our next step is to explore the effects of re-leveling a factor with the gapminder data set. We drop the observations from the continent of Oceania. 
